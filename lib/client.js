window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$2 = "@haibala-aii/dsh-extensions-extensionshub/ExtensionCenter.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@haibala-aii/dsh-extensions-extensionshub";
		...
		*/
		...
		const tagId$1 = "@haibala-aii/dsh-extensions-extensionshub/ExtensionNav.module.css";
		...
		*/
		...
		const tagId = "@haibala-aii/dsh-extensions-extensionshub/ExtensionOverlay.module.css";
