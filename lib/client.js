window.__ModuleLoader__.load({
	id: "@haibala/dsh-extensions-extensionshub",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region src/client/ExtensionFooter.tsx
		/**
		...
		*/
		function ExtensionFooter({ wide, t, actions }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
					className: clsx(ExtensionNav_module_css_default.item, !wide && ExtensionNav_module_css_default.rail),
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:E:\dsh\packages\client\ui-extensions\src\client\ExtensionOverlay.module.css.mjs
		const css = "._3YwXWa_overlay{background:var(--dsw-alias-bg-base);flex-direction:column;display:flex;position:absolute;inset:0}._3YwXWa_close{z-index:1;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);height:32px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:8px;padding:0 12px;font-size:13px;position:absolute;top:16px;right:20px}";
		const tagId = "@haibala/dsh-extensions-extensionshub/ExtensionOverlay.module.css";
		...
		var ExtensionOverlay_module_css_default = {
			"close": "_3YwXWa_close",
			"overlay": "_3YwXWa_overlay"
		};
		//#endregion
		//#region src/client/ExtensionOverlay.tsx
		/**
		...
		*/
		function ExtensionOverlay({ t, loadCatalog, useStore, actions, useSessions, useWorkspaces }) {
			if (!useStore((s) => s.overlayOpen)) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: ExtensionOverlay_module_css_default.overlay,
				role: "dialog",
				"aria-label": t("center.title"),
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: ExtensionOverlay_module_css_default.close,
					onClick: () => {
						actions.closeOverlay();
					},
					children: t("center.close")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ExtensionCenter, {
					t,
					loadCatalog,
					useSessions,
					useWorkspaces
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("sidebar.footer.action", () => {
				if (ctx.slots.spec("sidebar.nav") !== void 0) return () => {};
			...
			ctx.slots.inject("shell.overlay", () => {
				if (ctx.slots.spec("shell.surface") !== void 0) return () => {};
				return ctx.slots.register({
					name: "shell.overlay",
					id: "extensions",
					locale: NS,
