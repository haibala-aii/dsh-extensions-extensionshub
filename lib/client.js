window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$2 = "@haibala/dsh-ui-extensions/ExtensionCenter.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@haibala/dsh-ui-extensions";
		...
		*/
		...
		const tagId$1 = "@haibala/dsh-ui-extensions/ExtensionNav.module.css";
		...
		*/
		...
		const tagId = "@haibala/dsh-ui-extensions/ExtensionOverlay.module.css";
